...
$GLOBALS['TL_LANG']['XPT']['pct_theme_installer']['version_conflict'] 			= 'Please use one of Contaos LTS versions: 4.9';$GLOBALS['TL_LANG']['XPT']['pct_theme_installer']['memory_limit']				= 'Memory Limit (memory_limit) too low (%s). Min.: 512M';