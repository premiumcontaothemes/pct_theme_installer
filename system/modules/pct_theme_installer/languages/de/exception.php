...
$GLOBALS['TL_LANG']['XPT']['pct_theme_installer']['version_conflict'] 			= 'Bitte nutzen Sie Contaos LTS Versionen: 4.9';$GLOBALS['TL_LANG']['XPT']['pct_theme_installer']['memory_limit']				= 'Memory Limit (memory_limit) zu gering (%s). Min.: 512M';$GLOBALS['TL_LANG']['XPT']['pct_theme_installer']['memory_limit']				= 'Memory Limit (memory_limit) zu gering (%s). Min.: 512M';