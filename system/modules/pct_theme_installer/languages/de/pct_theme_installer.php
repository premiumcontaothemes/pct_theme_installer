...
$GLOBALS['TL_LANG']['PCT_THEME_INSTALLER']['TEMPLATE']['not_compatible'] 					= 'Bestellung: %s</br>Bestelldatum: %s<br><br>%s ist nicht kompatibel mit dieser Contao-Version';		
...
$GLOBALS['TL_LANG']['PCT_THEME_INSTALLER']['BACKEND_DESCRIPTION']['installation.clear_cache'] 			= 'Cache wird mit den neuen Informationen erstellt.';
